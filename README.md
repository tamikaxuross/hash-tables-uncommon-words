# Hash Tables Uncommon Words
Classroom activity to accompany the Hash Tables topic in Learn.
...
- Challenge #1
  - Extend to handle any number of sentences. A word may still only occur once in the sentence in which it appears to be considered uncommon.
- Challenge #2
